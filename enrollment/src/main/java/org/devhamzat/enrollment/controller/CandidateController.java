...
public class CandidateController {
    ...
    public ResponseEntity<String> enroll( @RequestBody Candidate candidate) {
        ResponseEntity<String> responseEntity = candidateEnrollmentFactory.enrollStudent(candidate);
