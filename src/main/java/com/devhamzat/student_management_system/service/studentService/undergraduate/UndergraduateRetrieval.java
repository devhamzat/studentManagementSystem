...
import com.devhamzat.student_management_system.utils.idGenerator.studentIDGenereator.UndergradauteStudentIDGenerator;
...
@Service
public class UndergraduateRetrieval implements StudentRetrievalService {
    ...
    @Autowired
    private UndergraduateRetrieval(StudentRepository studentRepository, UndergradauteStudentIDGenerator undergradauteStudentIDGenerator) {
    ...
    public boolean studentType(StudentType studentType) {
        return studentType.equals(StudentType.UNDER_GRADUATE);
    }
}
